...
/* каждый контейнер олицетворяет уровень доступности.
 * 1. На весь проект. Существует всегда.
 * 2. для уровня. Лежит внутри контейнера проекта. Существует только на сцене.
 * 3. для View моделей. Могут доставать данные из верхних слоёв, но верхние слои не имеют доступа к нижним. */
namespace BaCon
{
